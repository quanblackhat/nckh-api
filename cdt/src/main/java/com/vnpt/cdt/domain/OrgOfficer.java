...
public class OrgOfficer implements Serializable {
    ...
    @Size(max = 1000)
    @Column(name = "officer_name", length = 1000)
    ...
    public OrgOfficer nhanviens(Set<CdtNhanVien> cdtNhanViens) {
        this.nhanviens = cdtNhanViens;
        return this;
    }

    public OrgOfficer addNhanvien(CdtNhanVien cdtNhanVien) {
        this.nhanviens.add(cdtNhanVien);
        cdtNhanVien.setOrgOfficer(this);
        return this;
    }

    public OrgOfficer removeNhanvien(CdtNhanVien cdtNhanVien) {
        this.nhanviens.remove(cdtNhanVien);
        cdtNhanVien.setOrgOfficer(null);
        return this;
    }
