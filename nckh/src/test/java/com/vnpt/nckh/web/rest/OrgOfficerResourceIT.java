...
public class OrgOfficerResourceIT {
    ...
    private static final Long SMALLER_DEPT_ID = 1L - 1L;

    private static final Long DEFAULT_SUB_DEPT_ID = 1L;
    private static final Long UPDATED_SUB_DEPT_ID = 2L;
    private static final Long SMALLER_SUB_DEPT_ID = 1L - 1L;
    ...
    public void createOrgOfficer() throws Exception {
        ...
        assertThat(testOrgOfficer.getDeptId()).isEqualTo(DEFAULT_DEPT_ID);
        assertThat(testOrgOfficer.getSubDeptId()).isEqualTo(DEFAULT_SUB_DEPT_ID);
    }
    ...
    public void getAllOrgOfficers() throws Exception {
        ...
        restOrgOfficerMockMvc.perform(get("/api/org-officers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].subDeptId").value(hasItem(DEFAULT_SUB_DEPT_ID.intValue())));
    }
    ...
    public void getOrgOfficer() throws Exception {
        ...
        restOrgOfficerMockMvc.perform(get("/api/org-officers/{id}", orgOfficer.getId()))
            ...
            .andExpect(jsonPath("$.subDeptId").value(DEFAULT_SUB_DEPT_ID.intValue()));
    }
    ...
    @Test
    @Transactional
    public void getAllOrgOfficersByDeptIdIsEqualToSomething() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where deptId equals to DEFAULT_DEPT_ID
        defaultOrgOfficerShouldBeFound("deptId.equals=" + DEFAULT_DEPT_ID);

        // Get all the orgOfficerList where deptId equals to UPDATED_DEPT_ID
        defaultOrgOfficerShouldNotBeFound("deptId.equals=" + UPDATED_DEPT_ID);
    }

    @Test
    @Transactional
    public void getAllOrgOfficersByDeptIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where deptId not equals to DEFAULT_DEPT_ID
        defaultOrgOfficerShouldNotBeFound("deptId.notEquals=" + DEFAULT_DEPT_ID);

        // Get all the orgOfficerList where deptId not equals to UPDATED_DEPT_ID
        defaultOrgOfficerShouldBeFound("deptId.notEquals=" + UPDATED_DEPT_ID);
    }

    @Test
    @Transactional
    public void getAllOrgOfficersByDeptIdIsInShouldWork() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where deptId in DEFAULT_DEPT_ID or UPDATED_DEPT_ID
        defaultOrgOfficerShouldBeFound("deptId.in=" + DEFAULT_DEPT_ID + "," + UPDATED_DEPT_ID);

        // Get all the orgOfficerList where deptId equals to UPDATED_DEPT_ID
        defaultOrgOfficerShouldNotBeFound("deptId.in=" + UPDATED_DEPT_ID);
    }

    @Test
    @Transactional
    public void getAllOrgOfficersByDeptIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where deptId is not null
        defaultOrgOfficerShouldBeFound("deptId.specified=true");

        // Get all the orgOfficerList where deptId is null
        defaultOrgOfficerShouldNotBeFound("deptId.specified=false");
    }

    @Test
    @Transactional
    public void getAllOrgOfficersByDeptIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where deptId is greater than or equal to DEFAULT_DEPT_ID
        defaultOrgOfficerShouldBeFound("deptId.greaterThanOrEqual=" + DEFAULT_DEPT_ID);

        // Get all the orgOfficerList where deptId is greater than or equal to UPDATED_DEPT_ID
        defaultOrgOfficerShouldNotBeFound("deptId.greaterThanOrEqual=" + UPDATED_DEPT_ID);
    }

    @Test
    @Transactional
    public void getAllOrgOfficersByDeptIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where deptId is less than or equal to DEFAULT_DEPT_ID
        defaultOrgOfficerShouldBeFound("deptId.lessThanOrEqual=" + DEFAULT_DEPT_ID);

        // Get all the orgOfficerList where deptId is less than or equal to SMALLER_DEPT_ID
        defaultOrgOfficerShouldNotBeFound("deptId.lessThanOrEqual=" + SMALLER_DEPT_ID);
    }

    @Test
    @Transactional
    public void getAllOrgOfficersByDeptIdIsLessThanSomething() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where deptId is less than DEFAULT_DEPT_ID
        defaultOrgOfficerShouldNotBeFound("deptId.lessThan=" + DEFAULT_DEPT_ID);

        // Get all the orgOfficerList where deptId is less than UPDATED_DEPT_ID
        defaultOrgOfficerShouldBeFound("deptId.lessThan=" + UPDATED_DEPT_ID);
    }

    @Test
    @Transactional
    public void getAllOrgOfficersByDeptIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where deptId is greater than DEFAULT_DEPT_ID
        defaultOrgOfficerShouldNotBeFound("deptId.greaterThan=" + DEFAULT_DEPT_ID);

        // Get all the orgOfficerList where deptId is greater than SMALLER_DEPT_ID
        defaultOrgOfficerShouldBeFound("deptId.greaterThan=" + SMALLER_DEPT_ID);
    }


    @Test
    @Transactional
    public void getAllOrgOfficersBySubDeptIdIsEqualToSomething() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where subDeptId equals to DEFAULT_SUB_DEPT_ID
        defaultOrgOfficerShouldBeFound("subDeptId.equals=" + DEFAULT_SUB_DEPT_ID);

        // Get all the orgOfficerList where subDeptId equals to UPDATED_SUB_DEPT_ID
        defaultOrgOfficerShouldNotBeFound("subDeptId.equals=" + UPDATED_SUB_DEPT_ID);
    }

    @Test
    @Transactional
    public void getAllOrgOfficersBySubDeptIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where subDeptId not equals to DEFAULT_SUB_DEPT_ID
        defaultOrgOfficerShouldNotBeFound("subDeptId.notEquals=" + DEFAULT_SUB_DEPT_ID);

        // Get all the orgOfficerList where subDeptId not equals to UPDATED_SUB_DEPT_ID
        defaultOrgOfficerShouldBeFound("subDeptId.notEquals=" + UPDATED_SUB_DEPT_ID);
    }

    @Test
    @Transactional
    public void getAllOrgOfficersBySubDeptIdIsInShouldWork() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where subDeptId in DEFAULT_SUB_DEPT_ID or UPDATED_SUB_DEPT_ID
        defaultOrgOfficerShouldBeFound("subDeptId.in=" + DEFAULT_SUB_DEPT_ID + "," + UPDATED_SUB_DEPT_ID);

        // Get all the orgOfficerList where subDeptId equals to UPDATED_SUB_DEPT_ID
        defaultOrgOfficerShouldNotBeFound("subDeptId.in=" + UPDATED_SUB_DEPT_ID);
    }

    @Test
    @Transactional
    public void getAllOrgOfficersBySubDeptIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where subDeptId is not null
        defaultOrgOfficerShouldBeFound("subDeptId.specified=true");

        // Get all the orgOfficerList where subDeptId is null
        defaultOrgOfficerShouldNotBeFound("subDeptId.specified=false");
    }

    @Test
    @Transactional
    public void getAllOrgOfficersBySubDeptIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where subDeptId is greater than or equal to DEFAULT_SUB_DEPT_ID
        defaultOrgOfficerShouldBeFound("subDeptId.greaterThanOrEqual=" + DEFAULT_SUB_DEPT_ID);

        // Get all the orgOfficerList where subDeptId is greater than or equal to UPDATED_SUB_DEPT_ID
        defaultOrgOfficerShouldNotBeFound("subDeptId.greaterThanOrEqual=" + UPDATED_SUB_DEPT_ID);
    }

    @Test
    @Transactional
    public void getAllOrgOfficersBySubDeptIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where subDeptId is less than or equal to DEFAULT_SUB_DEPT_ID
        defaultOrgOfficerShouldBeFound("subDeptId.lessThanOrEqual=" + DEFAULT_SUB_DEPT_ID);

        // Get all the orgOfficerList where subDeptId is less than or equal to SMALLER_SUB_DEPT_ID
        defaultOrgOfficerShouldNotBeFound("subDeptId.lessThanOrEqual=" + SMALLER_SUB_DEPT_ID);
    }

    @Test
    @Transactional
    public void getAllOrgOfficersBySubDeptIdIsLessThanSomething() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where subDeptId is less than DEFAULT_SUB_DEPT_ID
        defaultOrgOfficerShouldNotBeFound("subDeptId.lessThan=" + DEFAULT_SUB_DEPT_ID);

        // Get all the orgOfficerList where subDeptId is less than UPDATED_SUB_DEPT_ID
        defaultOrgOfficerShouldBeFound("subDeptId.lessThan=" + UPDATED_SUB_DEPT_ID);
    }

    @Test
    @Transactional
    public void getAllOrgOfficersBySubDeptIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);

        // Get all the orgOfficerList where subDeptId is greater than DEFAULT_SUB_DEPT_ID
        defaultOrgOfficerShouldNotBeFound("subDeptId.greaterThan=" + DEFAULT_SUB_DEPT_ID);

        // Get all the orgOfficerList where subDeptId is greater than SMALLER_SUB_DEPT_ID
        defaultOrgOfficerShouldBeFound("subDeptId.greaterThan=" + SMALLER_SUB_DEPT_ID);
    }


    @Test
    @Transactional
    public void getAllOrgOfficersByNckhNhanSuIsEqualToSomething() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);
        NckhNhanSu nckhNhanSu = NckhNhanSuResourceIT.createEntity(em);
        em.persist(nckhNhanSu);
        em.flush();
        orgOfficer.addNckhNhanSu(nckhNhanSu);
        orgOfficerRepository.saveAndFlush(orgOfficer);
        Long nckhNhanSuId = nckhNhanSu.getId();

        // Get all the orgOfficerList where nckhNhanSu equals to nckhNhanSuId
        defaultOrgOfficerShouldBeFound("nckhNhanSuId.equals=" + nckhNhanSuId);

        // Get all the orgOfficerList where nckhNhanSu equals to nckhNhanSuId + 1
        defaultOrgOfficerShouldNotBeFound("nckhNhanSuId.equals=" + (nckhNhanSuId + 1));
    }


    @Test
    @Transactional
    public void getAllOrgOfficersByOrgOrganizationIsEqualToSomething() throws Exception {
        // Initialize the database
        orgOfficerRepository.saveAndFlush(orgOfficer);
        OrgOrganization orgOrganization = OrgOrganizationResourceIT.createEntity(em);
        em.persist(orgOrganization);
        em.flush();
        orgOfficer.setOrgOrganization(orgOrganization);
        orgOfficerRepository.saveAndFlush(orgOfficer);
        Long orgOrganizationId = orgOrganization.getId();

        // Get all the orgOfficerList where orgOrganization equals to orgOrganizationId
        defaultOrgOfficerShouldBeFound("orgOrganizationId.equals=" + orgOrganizationId);

        // Get all the orgOfficerList where orgOrganization equals to orgOrganizationId + 1
        defaultOrgOfficerShouldNotBeFound("orgOrganizationId.equals=" + (orgOrganizationId + 1));
    }
    ...
    public void updateOrgOfficer() throws Exception {
        ...
        assertThat(testOrgOfficer.getDeptId()).isEqualTo(UPDATED_DEPT_ID);
        assertThat(testOrgOfficer.getSubDeptId()).isEqualTo(UPDATED_SUB_DEPT_ID);
    }
